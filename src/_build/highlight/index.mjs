    ...
    while (true) {
        ...
        const highlighted = rawHighlighted
            ...
            .replace(
                ...
                '<b class="conum">($1)</b>')
            .replace(
                /<b<\/span> <span class="hljs-string">class="conum">\((\d+)\)<\/b>/g,
                '<b class="conum">($1)</b>')
            .replace(
                /<b class="<span">"conum"&gt;(<span class="hljs-number">(\d+)<\/span>)<\/b>/g,
                '<b class="conum">($1)</b>')
            .replace(
                /<b class=<span class="hljs-string">"conum"<\/span>>\(<span class="hljs-number">(\d+)<\/span>\)<\/b>/g,
                '<b class="conum">($1)</b>');
